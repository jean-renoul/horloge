...
# Définir les heures initiales pour l'alarme, la pause et l'heure actuelle
heure = (10, 25, 13)
alarme = (10, 25, 15)
pause = (10, 25, 17)
...
# Créer des objets datetime pour les temps d'alarme et de pause
...
# Fonction pour gérer la fonctionnalité de pause
...
# Fonction pour gérer la fonctionnalité d'alarme
def reveil(x):
    if x == alarme_datetime:
        print("ALERTE ALERTE ALERTE")

# Fonction pour formater l'heure en format AM/PM ou 24 heures
